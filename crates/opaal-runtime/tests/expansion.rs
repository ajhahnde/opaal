...
use opaal_runtime::eval::{ExpandedWord, RuntimeErrorKind, expand_word};
...
fn source(text: &str) -> SourceFile {
    SourceFile::new(SourceId::new(1), "test.opaal", text)
}
...
fn scalar_interpolation_encodes_each_family_canonically() {
    ...
    scope
        .declare(
            ...
            Value::Float(opaal_runtime::FiniteFloat::new(1.5).unwrap()),
        )
        .unwrap();
    scope
