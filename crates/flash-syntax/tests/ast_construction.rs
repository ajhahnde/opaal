...
fn nodes_and_word_parts_retain_exact_source_spans() {
    ...
    let command = Statement::new(
        StatementKind::Job(flash_syntax::JobStatement {
            chain: flash_syntax::ConditionalChain::from_pipeline(
                flash_syntax::Pipeline::from_stage(AstNode::new(
                    flash_syntax::StageKind::Command(CommandStage {
    ...
    let flash_syntax::StageKind::Command(stage) =
...
fn span(source: &SourceFile, range: std::ops::Range<usize>) -> flash_syntax::Span {
