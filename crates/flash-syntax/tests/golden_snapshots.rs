...
use flash_syntax::{ParseOutcome, SourceFile, SourceId, parse, render_diagnostic};

const UPDATE_ENV: &str = "FLASH_UPDATE_GOLDENS";
...
fn ast_golden(script: &flash_syntax::Script) -> String {
