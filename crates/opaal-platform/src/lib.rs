...
//! Platform-neutral capability contracts for OPAAL.
//!
//! Host adapters implement [`Platform`] behind
...
/// in `const` contexts — a useful shape for constrained host adapters.
...
/// This keeps host-specific directory policy out of portable runtime code.
