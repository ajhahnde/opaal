...
/// The closed module origins constructible by the OPAAL foundation.
...
/// The first nominal OPAAL record type form.
#[derive(Clone, Debug, Eq, PartialEq)]
...
/// One closed nominal OPAAL variant type.
#[derive(Clone, Debug, Eq, PartialEq)]
...
pub struct Declaration {
    ...
    pub pattern: Pattern,
    /// The first binding retained for source observers.
    pub name: Identifier,
